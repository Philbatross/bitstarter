...
var outputJson = function(cheerioFormat)
{
   var outJsonString =  JSON.stringify(cheerioFormat, null,4);
   console.log(outJsonString);
}
...
if(require.main == module) {
	...
	.option('-u, --url <url of html>', 'URL for an html file')
      .parse(process.argv);
